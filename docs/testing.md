...
beyond what is committed. A third of that is the determinism tests below, which
run a sweep twice on purpose.
...
each of the three estimator adapters follows; where a seed comes from and what
